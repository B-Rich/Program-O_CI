...
?>
      ...
      <div class="formTable">
        ...
        <div class="row bold center underline sectionHeader" colspan="2">Debugging Options:</div>
        <div class="row">
          <div class="label"><label for="debug_level"><span class="helpButton" id="hb_debug_level"></span>Debug Level</label></div>
          <div class="input">
        ...
        <div class="row">
          <div class="label"><label for="debug_mode"><span class="helpButton" id="hb_debug_mode"></span>Debug Mode</label></div>
          <div class="input">
