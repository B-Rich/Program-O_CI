...
*/
	...
	*/
	$config['security']['recaptcha_public_key']	= '6LcNDOsSAAAAADtb1xrkfHjBZjvUUZ1Es9ePEvaq';
	$config['security']['recaptcha_private_key'] = '6LcNDOsSAAAAAGkQBsxICSfBE2WlkRSUAhfMAOwK'; 
