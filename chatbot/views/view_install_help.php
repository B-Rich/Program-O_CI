 ...
 ****************************************************/
?>
  <link rel="stylesheet" href="<?php echo base_url('assets/css') ?>/help.css" type="text/css">
  <style type="text/css">
    ...
    <div class="row" id="debug_level">
      <span class="label">Bot Debug Level</span>
      <div class="description">
        ...
        <ul>
          <li>
            <b>No Debugging:</b> No debug data is created. Improves bot
            performance by a small amount.
          </li>
          <li>
            <b>Errors Only:</b> Only error information is generated.
          </li>
          <li>
            <b>General/Errors:</b> Only basic information is generated, along with errors.
          </li>
          <li>
            <b>General/Errors/SQL:</b> In addition to the data generated in
