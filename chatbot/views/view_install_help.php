 ...
 ****************************************************/
?>
        <link rel="stylesheet" href="<?php echo base_url('assets') ?>/help.css" />
       ...
       <div class="bold center underline">Botmaster Info</div>
        ...
        <div class="row" id="new_install">
          ...
          <div class="description">
            If you're just doing an upgrade install, be sure to select the "Upgrade" option, as choosing "New Install"
            will wipe out any user, chatbot, or configuration settings that may be stored in the database. 
          </div>
        </div>
        ...
        <div class="row" id="use_membership">
          ...
          <div class="description">
            ...
            If you want to give members extra benefits, such as "Adult Oriented" chatbots, or other extra benefits, then
            this will allow you to employ a basic membership system, where users would register once, and then login thereafter.
            This is only the most basic of membership systems, though, so there is very little in the way of anti-spam measures
            or age verification. If you need something more advanced, let us know via <a href="http://www.program-o.com/forum/">the forums</a>.
          </div>
        </div>
        ...
        <div class="row" id="require_membership">
          ...
          <div class="description">
            Default: No (disabled)<br />
            This setting is only available if the membership system is enabled, above. When this setting is enabled, it will require all visitors to
